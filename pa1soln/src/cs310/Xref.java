...
public class Xref
{
    ...
    {
        Map<String,List<Integer>> theIdentifiers = new HashMap<String,List<Integer>>();
        String current;

            // Insert identifiers into the search tree
        while( ( current = tok.getNextID( ) ) != "" )
        {
        	//System.out.println("token: " + current + "  skippedText: " + tok.skippedText());
    ...
    public static void main( String [ ] args )
    {
        ...
        // It is OK if the following loop has been removed, since we are not using it.
